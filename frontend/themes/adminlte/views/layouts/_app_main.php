...
use frontend\themes\adminlte\widgets\Breadcrumbs;
...
<main class="app-main">
    ...
    <div class="app-content">
        ...
        <div class="container-fluid">
            ...
            <?= $this->render('app_main/_small_box'); ?>

            <?= $this->render('app_main/_info_box'); ?>

            <?= $this->render('app_main/_info_box_bg'); ?>

            <?= $this->render('app_main/_cards'); ?>

            <!--begin::Row-->
            <div class="row">
                <!-- Start col -->
                <div class="col-lg-7 connectedSortable">
                    <?= $this->render('app_main/_chart'); ?>
                    <!-- DIRECT CHAT -->
